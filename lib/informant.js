...
var init = function() {
	...
	console.log(store);	
	store.on('insert',function(rec) {
		console.log(rec);
		io.sockets.volatile.emit(rec.type,rec);
	});

	store.on('loaded',function(server) {
...
var MemStore = function() {
	...
	this.emit('loaded',server_info);

};

var events = require('events');
MemStore.prototype = new events.EventEmitter();
MongoStore.prototype = new events.EventEmitter();
